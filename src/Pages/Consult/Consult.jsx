...
const Consult = () => {
  return (
    <div className="bg-cover bg-[url('https://i.ibb.co/GJbjP55/team-young-specialist-doctors-standing-corridor-hospital.jpg')] my-20">
      <div className=" grid md:grid-cols-4 py-20 lg:grid-cols-3 mx-auto gap-2 mb-10 bg-black bg-opacity-70">
        <div  className="w-4/5 mx-auto md:col-span-2 lg:col-span-2 lg:mt-5">
        ...
        <div className="w-4/5 mx-auto mt-10 lg:mt-0">
