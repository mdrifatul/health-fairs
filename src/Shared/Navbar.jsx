...
const navLink = (
  <>
    ...
    <NavLink to="/doctors" className={({isActive}) => isActive ? activeLink:normalLink} >Doctors</NavLink>
    </span>
    <span className="flex justify-center items-center p-2 text-lg">
    <NavLink to="/appoinment" className={({isActive}) => isActive ? activeLink:normalLink}>Appoinment</NavLink>
    </span>
    ...
    <div>
      <div className="navbar bg-white">
        <div className="navbar-start">
          ...
          <Link
            to="/"
            className="px-6 font-semibold text-xl md:text-3xl text-blue"
          >
            Health Fair
          </Link>
        </div>
